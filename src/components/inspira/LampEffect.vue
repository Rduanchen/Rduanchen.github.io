...
<template>
  <div
    class="relative z-0 flex min-h-screen w-full flex-col items-center justify-center overflow-hidden rounded-md bg-slate-100 dark:bg-slate-950"
    :class="[$props.class]"
  >
    <div
    ...
    >
      ...
      >
        <div
          class="absolute bottom-0 left-0 z-20 h-40 w-full bg-slate-100 dark:bg-slate-950 [mask-image:linear-gradient(to_top,white,transparent)]"
        />
        <div
          class="absolute bottom-0 left-0 z-20 h-full w-40 bg-slate-100 dark:bg-slate-950 [mask-image:linear-gradient(to_right,white,transparent)]"
        />
      </div>
      ...
      >
        <div
          class="absolute right-0 bottom-0 z-20 h-full w-40 bg-slate-100 dark:bg-slate-950 [mask-image:linear-gradient(to_left,white,transparent)]"
        />
        <div
          class="absolute right-0 bottom-0 z-20 h-40 w-full bg-slate-100 dark:bg-slate-950 [mask-image:linear-gradient(to_top,white,transparent)]"
        />
      </div>

      <div
        class="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-slate-100 dark:bg-slate-950 blur-2xl"
      />
      ...
      <div
        class="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-sky-500 dark:bg-cyan-500 opacity-45 blur-3xl"
      />

      <!-- Spotlight -->
      <div
        class="animate-spotlight absolute inset-auto z-30 h-36 w-32 -translate-y-24 rounded-full bg-sky-400 dark:bg-cyan-400 blur-2xl"
      />
    ...
    <div
      class="relative z-50 flex -translate-y-56 sm:-translate-y-64 md:-translate-y-72 flex-col items-center px-5"
    >
      <slot />
    </div>
  </div>
